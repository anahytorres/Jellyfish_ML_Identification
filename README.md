...
Step 3: run "jelly-model.ipynb" to train the model and obtain diagnostics and metrics, please pay attention to the comments because the code is rather desorganized, especially in the diagnostics section.
